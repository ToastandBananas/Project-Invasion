...
public class Shooter : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if ((defender != null && Vector2.Distance(transform.localPosition, defender.unitPosition) <= defender.minDistanceFromPosition && defender.squad.squadPlaced && defender.isRetreating == false && defender.squad.rangeCollider.attackersInRange.Count > 0 && defender.squad.attackersNearby.Count == 0)
